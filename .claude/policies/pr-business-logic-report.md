...
| ファイル種別 | 探索目的 |
|------------|---------|
| Controller | エンドポイント、権限チェック、リダイレクト分岐、ビジネスロジック呼び出し |
| Service | ビジネスロジックの詳細、計算処理、データ操作 |
| View/Template | 画面項目、表示条件、JavaScript機能 |
| Validation/Request | バリデーションルール、必須/任意項目、条件付き必須 |
| Model | リレーション、スコープ、アクセサ、ミューテータ |
| Enum/Constants | 定数定義、コード体系、選択肢 |
| Migration/Seeder | DB構造、初期データ |
